    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <div class="row-two" style="margin-left: 10px; margin-right: 10px;">
                        <?php
                            $sql2 = "SELECT employeeID FROM `employeeservice` where serviceID = 3";
                            ...
                            if ($result2 && mysqli_num_rows($result2) > 0) {
                                ...
                                while ($row2 = mysqli_fetch_assoc($result2)) {
                                    ...
                                    $sql5 = "SELECT * FROM servicecharge WHERE serviceID IN (3) AND endDate >= NOW() AND memberID = $row1[memberID]";
                                ...
                                echo '<table>
                                    <tr> 
                                        <td style=:"width:100%;"> Dieticians Unavailable at the Moment </td> 
                                    </tr>
                                </table>';
                            }
