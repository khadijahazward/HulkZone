...
<head>
    ...
    <link rel="stylesheet" href="css/viewAnnouncements.css">
...
<div class="sidebar">
      <div class="gymLogo"><img src="../../HulkZone/asset/images/gymLogo.png" alt=""></div>
            <div class="sidebarContent">
                ...
                <hr>
                <div class="tab"><a href="#Announcements"><i class='fas fa-bullhorn' style="padding-right: 15px;"></i>Announcements</a></div>
                <hr>
    ...
    <div class="down">
        ...
        <div class="tableAnnouncements">
            <table class="announcements">
                ...
                <tr>
                   <td>01</td>
                   <td>Gym is closed today</td>
                   <td>12/11/2022</td>
                   <td><button class="button1">Delete</button> <button class="button2" style="width: 120px;margin-top:1px">Edit</button></td>
                  
                </tr>
                <tr>
                   <td>02</td>
                   <td>Keep the gym clean</td>
                   <td>12/11/2022</td>
                   <td><button class="button1">Delete</button> <button class="button2" style="width: 120px;margin-top:1px">Edit</button></td>
                </tr>
            </table>
