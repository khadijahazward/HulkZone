                    ...
                    <form method="post">
                        ...
                        <div class="addresss" style="border:thick solid #006837;border-width:2px;border-radius:5px;padding-bottom:5px;margin-right:5px;">
                            ...
                            <div class="form-row">
                                <div class="form-group" style="margin-right:50px;">
                                    <label>NIC</label>
                                    <input id="nic" type="text" name="nic" value="<?php echo $userDetails['NIC']; ?>">
                            ...
                            <div class="form-row">
                                <div class="form-group" style="margin-right:50px;">
                                    ...
                                    <input id="number" type="text" name="number" value="<?php echo $userDetails['contactNumber']; ?>">

                                </div>

                                <div class="form-group">
                                    <label>Gender</label>
                                    <input id="nic" type="text" name="nic" value="<?php echo $userDetails['gender']; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="addresss" style="border:thick solid #006837;border-width:2px;border-radius:5px;padding-bottom:5px;margin-right:5px;margin-bottom:7px;">
                            ...
                            <div class="form-row">
                                <div class="form-group" style="margin-right:50px;">
                                    ...
                                    <input id="aline2" name="aline2" type="text" value="<?php echo $employeeDetails['qualification']; ?>" readonly>
                                </div>

                                <div class="form-group">
                                    <label>Description</label>
                                    <br>
                                    <textarea name="des" id="" cols="40" rows="8" readonly><?php echo $employeeDetails['description']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="city" name="city" type="text" value="<?php echo $employeeDetails['language']; ?>" readonly>
                                </div>
                            </div>
