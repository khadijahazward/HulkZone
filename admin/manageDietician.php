    ...
    <div class="right">
        ...
        <div class="content">
            <div class="contentLeft">
                <p class="title" style="width:250px ;">MANAGE DIETICIANS</p>
            </div>
            <div>
      ...
      <div class="contentRight" style="margin-left: 0px;"><img src="<?php echo $profilePictureLink ?>" alt="AdminLogo" class="adminLogo"></div>
        ...
        WHERE user.roles = 3";
                   ...
                   <td>
                   <form method='POST' action='accountStatusButton/changeStatusDietician.php' onsubmit='return confirmSubmission()'>
