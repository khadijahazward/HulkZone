                ...
                <form method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input id="dob" type="date" name="dateOfBirth" min="1930-01-01" max="2004-12-31" value="<?php echo "$dOfBirth" ?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group" style="margin-right:50px;">
                            ...
                            <input id="number" type="text" name="gender" value="<?php echo "$cNum" ?>" >

                        </div>

                        <div class="form-group">
                            <label>Gender</label>
                            <input id="gender" type="text" name="gender" value="<?php echo "$gender" ?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group" style="margin-right:50px;">
                            ...
                            <input id="streetNumber" name="streetNumber" type="text" value="<?php echo "$stNum" ?>" >
                        </div>

                        <div class="form-group">
                            <label>Address Line 01</label>
                            <input id="aline1" name="addressLine01" type="text" value="<?php echo "$addL1" ?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group" style="margin-right:50px;">
                            ...
                            <input id="aline2" name="addressLine02" type="text" value="<?php echo "$addL2" ?>">
                        </div>
