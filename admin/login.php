...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //login successful
    if ($verify == true && $count == 1 && $row['roles'] == 0) {
        session_start();
...
<head>
    ...
    <link rel="stylesheet" href="../../HulkZone/style/index.css">
    <link rel="stylesheet" type="text/css" href="../../HulkZone/style/login.css">
</head>
<body>
    <!--navigation bar-->
    <div class="nav-bar">
    ...
    <div class="content">
        ...
        <div class="loginbox" >
            <img src="../../HulkZone/asset/images/gymLogo.png" alt="GymLogo" class="GymLogo">
            <h1>Login</h1>
            <form action="../../HulkZone/admin/login.php" method="post" onsubmit="return validation()" id="loginForm">
