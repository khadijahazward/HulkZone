...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $query2 = "SELECT * FROM dietplan WHERE memberID = '$memberID' AND day = 'Thursday' ";
...
<head>
    ...
    <link href="Style/createDietPlanThursday.css" rel="stylesheet">
</head>
    ...
    <div class="container">
        ...
        <div class="dateBar">
            ...
            <div class="dateRow">
                ...
                <a>Tuesday</a>
                <a>Wednesday</a>
                <a style="color: rgba(0, 104, 55, 1);">Thursday</a>
                <a>Friday</a>
                <a>Saturday</a>
                <a>Sunday</a>
            </div>
