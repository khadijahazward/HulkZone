...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $query2 = "SELECT * FROM dietplan WHERE memberID = '$memberID' AND day = 'Tuesday' ";
...
<head>
    ...
    <link href="Style/createDietPlanTuesday.css" rel="stylesheet">
</head>
...
<body>
    <div class="container">
        ...
        <div class="dateBar">
            ...
            <div class="dateRow">
                <a>Monday</a>
                <a style="color: rgba(0, 104, 55, 1);">Tuesday</a>
                <a>Wednesday</a>
                <a>Thursday</a>
                <a>Friday</a>
                <a>Saturday</a>
