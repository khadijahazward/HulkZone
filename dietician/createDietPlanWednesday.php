...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $query2 = "SELECT * FROM dietplan WHERE memberID = '$memberID' AND day = 'Wednesday' ";
...
<head>
    ...
    <link href="Style/createDietPlanWednesday.css" rel="stylesheet">
</head>
    ...
    <div class="container">
        ...
        <div class="dateBar">
            ...
            <div class="dateRow">
                <a>Monday</a>
                <a>Tuesday</a>
                <a style="color: rgba(0, 104, 55, 1);">Wednesday</a>
                <a>Thursday</a>
                <a>Friday</a>
                <a>Saturday</a>
                <a>Sunday</a>
