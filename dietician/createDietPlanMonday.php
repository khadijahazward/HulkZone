...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $query2 = "SELECT * FROM dietplan WHERE memberID = '$memberID' AND day = 'Monday' ";
...
<head>
    ...
    <link href="Style/createDietPlanMonday.css" rel="stylesheet">
</head>
...
<body>
    <div class="container">
        ...
        <div class="gridContainer">
            ...
            <button class="saveButton" type="submit" name="next">Next</button>
        </div>
    </div>
</body>
